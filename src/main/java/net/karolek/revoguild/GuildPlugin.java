	...
	protected boolean registerDatabase() {
		...
		switch (StoreMode.getByName(Config.DATABASE_MODE)) {
			...
			default:
				...
				if (conn) {
					store.update(true, "CREATE TABLE IF NOT EXISTS `{P}guilds` (`id` int(10) NOT NULL AUTO_INCREMENT,`tag` varchar(4) COLLATE utf8_polish_ci NOT NULL,`name` varchar(32) COLLATE utf8_polish_ci NOT NULL,`owner` varchar(36) COLLATE utf8_polish_ci NOT NULL,`leader` varchar(36) COLLATE utf8_polish_ci NOT NULL,`cuboidWorld` varchar(32) COLLATE utf8_polish_ci NOT NULL,`cuboidX` int(10) NOT NULL,`cuboidZ` int(10) NOT NULL,`cuboidSize` int(10) NOT NULL,`homeWorld` varchar(32) COLLATE utf8_polish_ci NOT NULL,`homeX` int(10) NOT NULL,`homeY` int(10) NOT NULL,`homeZ` int(10) NOT NULL,`lives` int(2) NOT NULL DEFAULT '3',`createTime` bigint(13) NOT NULL DEFAULT '0',`expireTime` bigint(13) NOT NULL DEFAULT '0',`lastTakenLifeTime` bigint(13) NOT NULL DEFAULT '0',`pvp` int(1) NOT NULL DEFAULT '0',PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci AUTO_INCREMENT=1 ;");
					store.update(true, "CREATE TABLE IF NOT EXISTS `{P}members` (`id` int(10) NOT NULL AUTO_INCREMENT,`uuid` varchar(36) COLLATE utf8_polish_ci NOT NULL,`tag` varchar(4) COLLATE utf8_polish_ci NOT NULL,PRIMARY KEY (`id`),UNIQUE KEY `uuid` (`uuid`)) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci AUTO_INCREMENT=1 ;");
				}
				return conn;
		}
	}
