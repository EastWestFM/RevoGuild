		...
		switch (StoreMode.getByName(Config.DATABASE_MODE)) {
			...
			default:
				...
				if(conn) {
					...
					store.updateNow("CREATE TABLE IF NOT EXISTS `cube_members` (`id` int(10) NOT NULL AUTO_INCREMENT,`uuid` varchar(36) COLLATE utf8_polish_ci NOT NULL,`tag` varchar(4) COLLATE utf8_polish_ci NOT NULL,PRIMARY KEY (`id`),UNIQUE KEY `uuid` (`uuid`)) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci AUTO_INCREMENT=1 ;");
				}
				return conn;
		}
	}
